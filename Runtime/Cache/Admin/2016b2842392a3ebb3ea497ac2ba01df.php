...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>系统统计</strong></div>
  <div class="body-content">
  		<div class="transaction_style">
   <ul class="state-overview clearfix">
    <li class="Info">
     <span class="symbol red"><i class="fa fa-jpy"></i></span>
     <span class="value"><h4>平均办理时间</h4><p class="Quantity color_red">30分钟21秒</p></span>
    </li>
     <li class="Info">
     <span class="symbol  blue"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>最长办理时间</h4><p class="Quantity color_red">62分钟</p></span>
    </li>
     <li class="Info">
     <span class="symbol terques"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>最短办理时间</h4><p class="Quantity color_red">8分钟</p></span>
    </li>
     <li class="Info">
     <span class="symbol yellow"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>最多呼叫次数</h4><p class="Quantity color_red">849</p></span>
    </li>
     <li class="Info">
     <span class="symbol darkblue"><i class="fa fa-jpy"></i></span>
     <span class="value"><h4>平均呼叫次数</h4><p class="Quantity color_red">600</p></span>
    </li>
   </ul>
